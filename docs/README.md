...
└── archive/               # 🗄️ 历史文档 (1 个文档)
    └── EXPANSION_PLAN.md  # 补充计划（历史）
```

**文档统计**：
- **总计**：8 个核心文档
- **学习指南**：2 个（LEARNING_GUIDE.md, SHELL_GUIDE.md）
- **脚本清单**：2 个（CATALOG.md, scripts_index.md）
- **快速参考**：2 个（CHEATSHEET.md, STATS.md）
- **支持文档**：1 个（FAQ.md）
- **历史文档**：1 个（EXPANSION_PLAN.md）
