...
> 基于 **231 个实战脚本** 的系统性学习手册 | 从入门到 DevOps 实战 | 90 天学习计划

**仓库地址：** https://github.com/hjs2015/shell-notes  
**脚本总数：** **229 个** ✅ (重组后，2026-03-21 (优化版))  
**学习周期：** 90 天（从入门到实战）  
**目录结构：** 完全扁平化（前 5 阶段）  
**最后更新：** 2026-03-21 (优化版)
...
- 🗑️ **精简脚本数量**：268 → 229（删除 39 个重复脚本）
- 🔢 **连续编号系统**：每个阶段 01-XX 连续编号
- 📊 **优化目录数量**：43 → 15（删除 28 个空子目录）

**影响**：
- ✅ 路径简化：`01_basics/01_hello_world.sh`（无需子目录）
- ✅ 查找快速：直接按编号查找
- ✅ 引用方便：连续编号便于文档引用

**查看重组详情**：[重组报告](/root/.copaw/reports/shell_notes_deep_reorganization_complete.md)
...
**脚本：** [`01_basics/01_hello_world.sh`](01_basics/01_hello_world.sh)
...
**脚本：** [`01_basics/07_arithmetic.sh`](01_basics/07_arithmetic.sh)
...
**脚本：** [`01_basics/08_comparison.sh`](01_basics/08_comparison.sh)
...
**脚本：** [`01_basics/09_logical.sh`](01_basics/09_logical.sh)
...
**目录：** [`02_control_flow/`](02_control_flow/)
